...
namespace HttpReports.Web.DataContext
{
    ...
    {
        private readonly ConnectionStringSettingsCollection connectionSettings;
        private readonly NameValueCollection appSettings;
        public DBFactory()
        {
            connectionSettings = System.Configuration.ConfigurationManager.ConnectionStrings;
            appSettings = ConfigurationManager.AppSettings;
        }
        public SqlConnection GetSqlConnection()
        {
            return new SqlConnection(connectionSettings["HttpReports"].ConnectionString);
        }

        public MySqlConnection GetMySqlConnection()
        {
            return new MySqlConnection(connectionSettings["HttpReports"].ConnectionString);
        }
        public OracleConnection GeOracleConnection()
        {
            try
            {
                var conn = new OracleConnection(connectionSettings["HttpReports"].ConnectionString);
                //conn.Open();
                return conn;
            }
            catch (Exception)
        ...
        public void InitDB()
        {
            ...
            string Constr = connectionSettings["HttpReports"].ConnectionString;
        ...
        private void InitOracle(string Constr)
        {
