...
namespace HttpReports.Web.Controllers
{
    public class DataController : Controller
    {
        ...
        public ActionResult GetStatusCodePie(GetIndexDataRequest request)
        {
        ...
        public ActionResult GetMonthDataByYear(GetIndexDataRequest request)
        {
        ...
        public ActionResult GetTimeRange(int Tag)
        {
            if (Tag == 1)
            {
        ...
        public ActionResult GetTimeTag(string start, string end, int TagValue)
        {
        ...
        public ActionResult GetTOPART(GetTopRequest request)
        {
            request.Start = request.Start.IsEmpty() ? DateTime.Now.ToString("yyyy-MM-dd") : request.Start;
            request.End = request.End.IsEmpty() ? DateTime.Now.AddDays(1).ToString("yyyy-MM-dd") : request.End;
        ...
        public ActionResult GetRequestList(GetRequestListRequest request)
        {
            int totalCount = 0;
        ...
        public ActionResult EditJob(JobRequest request)
        {
